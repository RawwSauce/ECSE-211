...
public class NavigationA implements Runnable{
	...
	public void run() {
		while(counter < 5) {
    	  	try {
				travelTo(Lab3_v3.x[counter] * Lab3_v3.TILE_SIZE, Lab3_v3.y[counter] * Lab3_v3.TILE_SIZE);
	...
	public void travelTo(double x, double y) throws OdometerExceptions {
		...
		if(needAvoid()) {
			...
			leftMotor.rotate(convertDistance(Lab3_v3.WHEEL_RAD, (distance)), true);
			rightMotor.rotate(convertDistance(Lab3_v3.WHEEL_RAD, (distance)), true);
			while(isNavigating()) {
				if(needAvoid()) {
					avoidWall();
				}
	...
	public void turnTo(double theta) {
		...
		leftMotor.rotate(convertAngle(Lab3_v3.WHEEL_RAD, Lab3_v3.TRACK, turnAngle), true);
		rightMotor.rotate(-convertAngle(Lab3_v3.WHEEL_RAD, Lab3_v3.TRACK, turnAngle), false);
	}
	...
	public void avoidleft() {
		...
		leftMotor.rotate(convertAngle(Lab3_v3.WHEEL_RAD, Lab3_v3.TRACK, -90.0), true);
		rightMotor.rotate(-convertAngle(Lab3_v3.WHEEL_RAD, Lab3_v3.TRACK, -90.0), false);
		...
		while(usDistance[0] * 100 <= 30){
			...
			leftMotor.rotate(convertDistance(Lab3_v3.WHEEL_RAD, 25 ), true);     
			rightMotor.rotate(convertDistance(Lab3_v3.WHEEL_RAD, 25 ), false);		
			sampleProvider.fetchSample(usDistance , 0);
		}
		...
		rightMotor.rotate(-convertAngle(Lab3_v3.WHEEL_RAD, Lab3_v3.TRACK, 90.0), false);
		//moves straight
		leftMotor.rotate(convertDistance(Lab3_v3.WHEEL_RAD, distance * 2.1 ), true);     
		rightMotor.rotate(convertDistance(Lab3_v3.WHEEL_RAD, distance * 2.1 ), false);	
				
		centerMotor.rotateTo(90);
		sampleProvider.fetchSample(usDistance , 0);
		while(usDistance[0] * 100 <= 30){
			
			leftMotor.rotate(convertDistance(Lab3_v3.WHEEL_RAD, 20 ), true);     
			rightMotor.rotate(convertDistance(Lab3_v3.WHEEL_RAD, 20 ), false);		
			sampleProvider.fetchSample(usDistance , 0);
		}
	...
	public void avoidright() {
		...
		leftMotor.rotate(convertDistance(Lab3_v3.WHEEL_RAD, 10 ), true);     
		rightMotor.rotate(convertDistance(Lab3_v3.WHEEL_RAD, 10), false);
